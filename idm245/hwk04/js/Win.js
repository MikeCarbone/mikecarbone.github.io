...
gameObj.Win.prototype = {
  create: function () {
    ...
    let score = 124;
    var scoreText = this.add.text(this.world.centerX, 255, `Score: ${score}`, detailStyle);
    scoreText.anchor.setTo(0.5, 0.5);
    
    let time = '0:00';
    var timeText = this.add.text(this.world.centerX, 285, `Time remaining: ${time}`, detailStyle);
